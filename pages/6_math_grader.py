...
def grade_math(uploaded_file_path):
    ...
    data = {
            "model": "gemma3n:e4b",
            "prompt": f"Grade the math solution provided in this image: {uploaded_file_path}",
            "stream": False,
            }
...
uploaded_file = st.file_uploader("Upload a picture of your solution and have it graded!", type=["png", "jpg", "jpeg"])

# Grading button
if uploaded_file and st.button("Grade my solution"):
    ...
    if ext not in valid_exts:
        ...
        st.success("Your solution has been graded!")
        st.markdown(f"**Math grader Result:** {graded_output}")
elif not uploaded_file:
    st.info("Please upload an image file of your solution to get started.")