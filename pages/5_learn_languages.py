...
st.markdown("""
This page is designed to help students learn a new language. 
The student will be given a prompt in the language to teach and they will respond in that language. 
The AI will then correct their mistakes and provide feedback.
Supported languages include: Japanese, German, Korean, Spanish, and French,
